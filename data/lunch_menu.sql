...
INSERT INTO restaurants (name, category, location, operating_hours, contact) VALUES
    ('부산김밥', '분식', '구덕로 145', '09:00-21:00', '051-123-4567'),
    ('맛있는 김치찌개', '한식', '구덕로 157', '10:00-22:00', '051-234-5678'),
    ('버거킹 부민점', '패스트푸드', '구덕로 160', '10:00-22:00', '051-345-6789'),
    ('CU 부민점', '편의점', '구덕로 155', '24시간', '051-456-7890'),
    ('GS25 부민점', '편의점', '구덕로 165', '24시간', '051-567-8901');